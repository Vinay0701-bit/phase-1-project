...
public static void main(String[] args) {
		...
		do {
			...
			case 1:
				...
				try {
					File file = new File("C://Users//Vinay kumar//Desktop//" + filename + ".txt");
			...
			case 3:
				...
				File directory_delete = new File("C://Users//Vinay kumar//Desktop//");
				...
				if (flist_delete == null) {
					...
					for (int i = 0; i < flist_delete.length; i++) {
						...
						if (delete_filename.equalsIgnoreCase(filename)) {
							...
							File file = new File(
									"C://Users//Vinay kumar//Desktop//" + delete_filename);
							if (file.delete()) {
			...
			case 4:
				...
				File directory_search = new File("C://Users//Vinay kumar//Desktop//");
	...
	private static void listOfFiles() {
		...
		File folder = new File("C://Users//Vinay kumar//Desktop//");
